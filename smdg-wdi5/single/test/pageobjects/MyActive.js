module.exports = {
    myActivate: {
        ...
        selector: {
            ...
            i18NText: {
                propertyName: "text",
                key: "APP_SIDEBAR_ACTIVATEREQUESTS"
            }
        }
    },
// navigate tab single in activative
    activativeTypeSingle: {
        selector: {
            controlType: "sap.m.IconTabFilter",
            viewName: "com.laidon.simplemdg.view.ActivateRequest",
            i18NText: {
                propertyName: "text",
